...
1. `swift build`
1. `.build/debug/SwiftKituraKostnaderAPI`
...
#### Kubernetes
To deploy your application to your Kubernetes cluster, run `helm install --name myapp .` in the `/chart/SwiftKituraKostnaderAPI` directory. You need to make sure you change the `repository` variable in your `chart/SwiftKituraKostnaderAPI/values.yaml` file points to the docker image containing your runnable application.
